...
<svelte:head>
	...
	<meta
		name="keywords"
		content="cv, développeur, full stack, front, back, javascript, typescript, react, next, svelte, sveltekit, solidjs, méta-framework"
	/>
...
<CvLayout template="react" dark={IS_BLACK_AND_WHITE_THEME} job={JOB}>
	{#snippet header()}
...
<BtnPrint filename="react" />
<BtnTextVersion href={resolve('/cv/react/texte')} />
