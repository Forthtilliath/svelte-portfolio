<script lang="ts">
	...
	let { size = 24, color = '#e10098', class: className = undefined }: Props = $props();
...
<svg width={sizePx} height={sizePx} viewBox="0 0 32 32" fill={color} class={className}>
	<rect
		...
		width="22.901"
		height="1.187"
		transform="translate(-5.858 16.107) rotate(-60)"
	/>
	...
	<rect
		...
		width="1.187"
		height="13.227"
		transform="translate(-15.812 21.857) rotate(-60)"
	/>
	<rect
		x="20.381"
		y="0.771"
		width="1.187"
		height="13.227"
		transform="translate(4.092 21.856) rotate(-60)"
	/><rect
		x="4.412"
		y="6.787"
		width="13.227"
		height="1.187"
		transform="translate(-2.213 6.502) rotate(-30)"
	/>
	<rect
		x="20.389"
		y="1.677"
		width="1.187"
		height="22.901"
		transform="translate(-3.753 12.25) rotate(-30)"
	/>
	...
	<rect
		...
		width="11.504"
		height="1.037"
		transform="translate(-9.498 13.785) rotate(-30)"
	/>
